...
sel_isotherms = []
req_batch = ["KRICT AlO Pellets", "CH52", "KRICT PVA Pellets"]
...
for index, isotherm in enumerate(isotherms):
    if isotherm.batch == "CH52":
        isotherm.batch = "CH52 Powder"
...
sel_isotherms = [sel_isotherms[i] for i in [0, 1, 3]]
...
sel_isotherms = [sel_isotherms[i] for i in [1, 2, 3]]
...
plot_all_selected(sel_isotherms, save_data, 90, None, 20, save_folder=save_folder)
...
sel_isotherms = [sel_isotherms[i] for i in [0, 3, 4]]

plot_all_selected(sel_isotherms, save_data, 90, None, 10, save_folder=save_folder)
...
plot_all_selected(sel_isotherms, save_data, 90, None, None, save_folder=save_folder)
