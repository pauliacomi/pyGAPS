...
def reverse_iast(isotherms,
    ...
    if gas_mole_fraction_guess is None:
        ...
        numpy.testing.assert_almost_equal(1.0,
                                          numpy.sum(gas_mole_fraction_guess),
                                          decimal=4)
        # if list, convert to numpy array
