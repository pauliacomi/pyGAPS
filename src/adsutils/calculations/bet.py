...
def area_BET(isotherm, verbose=False):
    ...
    if verbose:
        ...
        ax2.plot(bet_points[isotherm.pressure_key], bet_points['BET'],
                 marker='o', color='r', label='chosen points')
        ax2.plot(adsorption[isotherm.pressure_key], adsorption['BET'],
        ...
        fig2 = plt.figure()
        ax2 = fig2.add_subplot(111)
        ax2.plot(bet_points[isotherm.pressure_key], bet_points['roquerol'],
                 marker='o', color='r', label='chosen points')
        ...
        print("Amount for a monolayer: n =",
              round(amount_monolayer, 3), "mol/g")
