...
class TestConversions():
    @pytest.mark.parametrize(
        'value, b_f, u_f, b_t, u_t, b_a, u_a', [
            ...
            (217.078, 'mass', 'g', 'volume', 'cm3', None, None),        # 1 g/g -> 217 cm3/g
            ...
            (6081.12, 'molar', 'mol', 'volume', 'cm3', None, None),     # 1 mol/g -> 6081 cm3/g
            (6.08112, 'molar', 'mmol', 'volume', 'cm3', None, None),    # 1 mmol/g -> 6.081 cm3/g
            (1e-6, 'volume', 'cm3', 'volume', 'm3', None, None),        # 1 cm3/g -> 1E-6 m3/g
            (4.606E-3, 'volume', 'cm3', 'mass', 'g', None, None),       # 1 cm3/g -> 4.6e-3 g/g
            (1.6444E-4, 'volume', 'cm3', 'molar', 'mol', None, None),   # 1 cm3/g -> 1.6444-4 mol/g
    ...
    def test_convert_adsorbent(
        self, value, b_f, u_f, b_t, u_t, use_material
    ):
