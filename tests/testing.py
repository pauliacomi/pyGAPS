...
adsutils.plot_iso({orig,model}, plot_type='isotherm', branch='ads', logarithmic=False, color=True)
...
plot_all_selected(sel_isotherms, False, None, None, None, save_folder=save_folder)
